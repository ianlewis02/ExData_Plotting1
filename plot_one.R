...
## Plot 1 - To create plot1.png as a Red Histogram
  plot1 <- function() {
  	hist(df_hpcdata$Global_active_power, main = "Global Active Power", col="red", xlab="Global Active Power (kilowatts)")
      dev.copy(png, file="plot1.png", width=480, height=480)
      dev.off()
  }
  print('Plot 1 Completed and plot1.png produced')
  plot1()
